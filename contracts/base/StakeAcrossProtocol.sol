...
/// @notice - This contract is used to stake tokens. Pay using LINK tokens
/// @dev - This contract is used to stake tokens on one chain and receive them on another chain.

contract StakeAcrossProtocol is CCIPReceiver, OwnerIsCreator {
