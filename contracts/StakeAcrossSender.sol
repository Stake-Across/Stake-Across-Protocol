...
/// It also inherits from the OwnerIsCreator contract, which restricts access to certain functions to the contract owner.
...
contract StakeAcrossSender is CCIPReceiver, OwnerIsCreator {
    ...
    function sendMessage(
        ...
        Client.EVM2AnyMessage memory evm2AnyMessage = Client.EVM2AnyMessage({
            ...
            extraArgs: Client._argsToBytes(
                Client.EVMExtraArgsV1({gasLimit: _gasLimit}) // Additional arguments, setting gas limit and non-strict sequency mode
            ),
    ...
    function getSendFees(
        ...
        message = Client.EVM2AnyMessage({
            ...
            extraArgs: Client._argsToBytes(
                Client.EVMExtraArgsV1({gasLimit: 800_000}) // Additional arguments, setting gas limit and non-strict sequency mode
            ),
